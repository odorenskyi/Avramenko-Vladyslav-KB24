...
Завдання:
1. Реалізувати програмні модулі розв’язування задач 10.1–10.3 як складові статичної бібліотеки libModulesAvramenko.а (проект ModulesAvramenko лабораторних робіт №8–9).
